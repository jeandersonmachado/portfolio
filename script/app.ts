...
const spanContainer = document.querySelector(".span_container") as HTMLDListElement;
const span = document.querySelectorAll(".span_container span") as NodeListOf<HTMLSpanElement>;
...
const navigatorLi = document.querySelectorAll("#navigator div") as NodeListOf<HTMLDivElement>;
const menuContainer = document.querySelector("#menu_container") as HTMLDivElement;
const cursorBorder = document.querySelector("#cursorBorder") as HTMLDivElement;
const cross = document.querySelector("#cross") as HTMLDivElement;
const spanWrapperSpan = document.querySelector("#span_wrapper span") as HTMLSpanElement;
const sectionImg = document.querySelectorAll(".section_img_son") as NodeListOf<HTMLDivElement>;
const aboutMe = document.querySelectorAll(".about_me div") as NodeListOf<HTMLDivElement>;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let mouseX: number = 0;
    let mouseY: number = 0;
    let circlePositionX: number = 0;
    let circlePositionY: number = 0;
    ...
    let mediaQuery: MediaQueryList = window.matchMedia("(max-width: 1199px)");
    ...
    function handleMediaQueryChange(event: any) {
        if (event.matches) {
            ...
            menuContainer.addEventListener("mousemove", () => {
                ...
                options(cursorBorder, {
                    transform: `translate(${spanContainerLeft + +cursorMoveX * 40}px, ${
                        spanContainerTop + +cursorMoveY * 40
                    }px)`,
                });
            });
            ...
            spanWrapperSpan.addEventListener("mouseout", () => {
                ...
                options(cursorBorder, {
                    transition:
                        "left 0.3s ease-out, width 0.3s ease-out, height 0.3s ease-out,background-color 0.15s ease-out, transform 0.3s ease-out, opacity 0.5s ease",
                });
    ...
    //options
    function elementConfiguration(): void {
        if (value === 0) {
            options(navigator, {
